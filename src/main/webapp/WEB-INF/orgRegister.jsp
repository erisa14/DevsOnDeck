...
<div class="form2 border border-3 border-dark">
    <h2 class="text-center mt-1 fw-bold">Organization Sign Up</h2>
    <div class="px-2">
        <form:form modelAttribute="newOrg" action="/orgs/register" method="post" class="form  d-flex flex-column">
            <div class="d-flex flex-row justify-content-center align-items-center">
                <p class="col-sm-3">
                    <form:label path="name" class="ms-2 fw-semibold form-label">Org Name</form:label>
                </p>
                <form:errors path="name" class="errors text-light"/>
