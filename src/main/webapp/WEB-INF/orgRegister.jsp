...
<div class="form2 mt-5 border border-3 border-dark">
    <h1 class="text-center mt-3 fw-bold">Organization Sign Up</h1>
    <div class="p-2">
        <form:form modelAttribute="newOrg" action="/orgs/register" method="post" class="form  d-flex flex-column">
            <div class="d-flex flex-row justify-content-center align-items-center gap-2">
                <p class="col-sm-2">
                    <form:label path="name" class="ms-2 fw-semibold col-form-label">Org Name</form:label>
                </p>
